      ...
      {expanded && (
        <div style={{ padding: `0 ${spacing.md}px ${spacing.xxs}px`, borderTop: `1px solid ${sc.border}` }}>
          {slotSupps.map((supp, i) => {
            ...
            return (
              <div key={supp.id} style={{ display: "flex", alignItems: "center", gap: spacing.xs, padding: `${spacing.sm}px 0`, borderBottom: i < slotSupps.length - 1 ? `1px solid ${theme.border.subtle}` : "none", minHeight: touch.row }}>
